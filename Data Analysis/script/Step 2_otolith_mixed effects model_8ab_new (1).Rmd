...
M5<- lmer(log(increment) ~ c.log.age + method + c.log.aac + c.f + (1 | FishID) + (1 + c.log.age| fyear) + c.(sbt.among) + c.(sbt.within), data, REML = T)
...
M6<- lmer(log(increment) ~ c.log.age + method + c.log.aac + c.f + (1 | FishID) + (1 + c.log.age| fyear) + c.(sbt.among) + c.(sbt.within) + (c.(sbt.within) |FishID), data, REML = T)
